    ...
    <div className="space-y-8">
      <header className="space-y-2">
        ...
        <p className="text-neutral-700">
          Math Olympiad, computer programming, and sciences — with in-person and online options.
        </p>
      </header>

 <section id="math" className="rounded-2xl border p-6 space-y-6">
      <div>
      ...
      <section id="cs" className="rounded-2xl border p-6">
        <h2 className="text-xl font-semibold">Computer Science</h2>
        <p className="mt-2 text-sm text-neutral-700">
          Scratch/Python for beginners, C++/algorithms for competition pathways.
        </p>
      </section>

      <section id="science" className="rounded-2xl border p-6">
        <h2 className="text-xl font-semibold">Sciences</h2>
        <p className="mt-2 text-sm text-neutral-700">
          Physics & Chemistry support with AP/IB pathways.
        </p>
      </section>
    </div>
  );
